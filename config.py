...
# --- LLM Models ---
LLM_GUARDRAIL_MODEL = os.getenv("LLM_GUARDRAIL_MODEL", "gpt-5.6-luna")
LLM_GUARDRAIL_REASONING_EFFORT = os.getenv("LLM_GUARDRAIL_REASONING_EFFORT", "none")
LLM_GUARDRAIL_VERBOSITY = os.getenv("LLM_GUARDRAIL_VERBOSITY", "low")

LLM_DATA_AGENT_MODEL = os.getenv("LLM_DATA_AGENT_MODEL", "gpt-5.6-terra")
...
LLM_DOCS_AGENT_MODEL = os.getenv("LLM_DOCS_AGENT_MODEL", "gpt-5.6-sol")
...
LLM_BUG_AGENT_MODEL = os.getenv("LLM_BUG_AGENT_MODEL", "gpt-5.6-sol")
...
LLM_TRIAGE_AGENT_MODEL = os.getenv("LLM_TRIAGE_AGENT_MODEL", "gpt-5.6-terra")
...
LLM_KNOWLEDGE_GAP_MODEL = os.getenv("LLM_KNOWLEDGE_GAP_MODEL", "gpt-5-mini")
LLM_KNOWLEDGE_GAP_REASONING_EFFORT = os.getenv("LLM_KNOWLEDGE_GAP_REASONING_EFFORT", "low")
LLM_KNOWLEDGE_GAP_VERBOSITY = os.getenv("LLM_KNOWLEDGE_GAP_VERBOSITY", "low")
...
TELEGRAM_HANDOFF_SUMMARY_TIMEOUT_SECONDS = _env_float(
    "TELEGRAM_HANDOFF_SUMMARY_TIMEOUT_SECONDS",
    15.0,
)
...
KNOWLEDGE_GAP_REPORT_CHANNEL_ID = _env_int(
    "KNOWLEDGE_GAP_REPORT_CHANNEL_ID",
)
TICKET_CONTRIBUTOR_ROLE_ID = _env_int(
    "TICKET_CONTRIBUTOR_ROLE_ID",
    894686596312485920,
)
TICKET_STAFF_SUMMON_PREFIX = "y:"
...
TICKET_EXECUTION_CODEX_SESSION_DIR = os.getenv(
    "TICKET_EXECUTION_CODEX_SESSION_DIR",
    _DEFAULT_TICKET_EXECUTION_CODEX_SESSION_DIR,
).strip() or None
TICKET_EXECUTION_CODEX_SESSION_MAX_AGE_HOURS = _env_int(
    "TICKET_EXECUTION_CODEX_SESSION_MAX_AGE_HOURS",
    168,
)
_DEFAULT_MCP_PORT = (
    _env_int(
...
SUPPORT_DASHBOARD_VERIFY_SSL = _env_bool("SUPPORT_DASHBOARD_VERIFY_SSL", True)
...
def ticket_execution_runtime_summary() -> str:
    ...
    if TICKET_EXECUTION_CODEX_SESSION_DIR:
