...
BD_PRIORITY_GUARDRAIL_INSTRUCTIONS = (
    ...
    "- If the user is directly disclosing a Yearn vulnerability, names a concrete contract/path/impact, or says Immunefi / identity verification / zkPassport is blocking submission and asks for a secure way to send the report, it is **'not_bd_pr'**. That is a security-report handling case, not vendor outreach.\n"
