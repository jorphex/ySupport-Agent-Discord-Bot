...
TICKET_TRIAGE_ROUTER_INSTRUCTIONS = (
    ...
    "- If the user asks about recovery policy, reclaim process, governance decisions, migration terms, or why someone would choose one supported option over another, route to `route_docs` even if a wallet address appears as background context. Only route to `route_data` if they explicitly ask for a personal deposit, balance, or claimable-amount lookup.\n"
