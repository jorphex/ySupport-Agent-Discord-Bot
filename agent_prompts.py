...
YEARn_BUG_TRIAGE_AGENT_INSTRUCTIONS = (
    ...
    "7. If essential information is missing, ask ONE focused follow-up question. Ask for a wallet address only if it is necessary to decide whether the problem is account-specific.\n"
