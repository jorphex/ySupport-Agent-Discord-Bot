...
def _codex_support_prompt(
    *,
    ...
    return (
        ...
        "Do not volunteer optional handoff or ask whether the user wants human review when the public evidence "
        "already answers the user’s main question.\n"
        "If the user did not ask for a human and the remaining gap is only internal curiosity about why a keeper, "
